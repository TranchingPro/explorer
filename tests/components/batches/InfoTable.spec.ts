...
const l1ExplorerUrlMock = vi.fn((): string | null => "https://calibration.filfox.info/en");
...
describe("InfoTable:", () => {
  ...
  it("renders urls properly", () => {
    ...
    expect(wrapper.findAll("a")[0].attributes("href")).toEqual(
      "https://calibration.filfox.info/en/tx/0x0ab34d8523b67f80783305760a2989ffe6ab205621813db5420a3012845f5ac7"
    );
    expect(wrapper.findAll("a")[1].attributes("href")).toEqual(
      "https://calibration.filfox.info/en/tx/0x87c5c5bf78100d88766101f13ec78d3b3356929556ee971cfacb6fe2a53b210a"
    );
    expect(wrapper.findAll("a")[2].attributes("href")).toEqual(
      "https://calibration.filfox.info/en/tx/0x57c44d7c183633f81bfa155bd30e68a94e3ff12c1e6265a4b5e06b6d4a7a1fa8"
    );
    wrapper.unmount();
  });
