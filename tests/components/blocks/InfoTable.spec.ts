...
describe("InfoTable:", () => {
  ...
  it("renders commitTxHash url properly", () => {
    ...
    expect(wrapper.findAll("a")[0].attributes("href")).toEqual(
      "https://calibration.filfox.info/en/tx/0x5b5a05691d974803f5f095c1b918d2dd19152ed0a9de506d545c96df6cb9cac2"
    );
  });
  it("renders proveTxHash url properly", () => {
    ...
    expect(wrapper.findAll("a")[1].attributes("href")).toEqual(
      "https://calibration.filfox.info/en/tx/0xfb3532f4c38c2eaf78248da64cf80a354429d58204761d6ea6439391043f6fa9"
    );
  });
  it("renders executeTxHash url properly", () => {
    ...
    expect(wrapper.findAll("a")[2].attributes("href")).toEqual(
      "https://calibration.filfox.info/en/tx/0x8d1a78d1da5aba1d0755ec9dbcba938f3920681d2a3d4d374ef265a50858f364"
    );
  });
