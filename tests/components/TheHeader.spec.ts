  ...
  return {
    default: () => ({
      currentNetwork: computed(() => ({
        ...
        l2WalletUrl: "https://portal.micro.io/",
        bridgeUrl: "https://bridge.micro.io/",
              })),
    }),
  };
});
...
describe("TheHeader:", () => {
  ...
  it("renders navigation links", async () => {
    ...
    expect(toolsLinks[2].attributes("href")).toBe("https://portal.micro.io/");

    expect(wrapper.findAll(".navigation-container > .navigation-link")[0].attributes("href")).toBe(
      "https://era.micro.io/docs/dev/"
    );
  });
  it("renders social links", () => {
    ...
    expect(routerArray[0].attributes("href")).toBe("https://join.micro.dev/");
    expect(routerArray[1].attributes("href")).toBe("https://twitter.com/micro");
  });
