...
Feature: Redirection
  ...
  Scenario Outline: Verify redirection for "<Extra button name>" on Footer for internal links
    ...
    Examples:
      ...
      | Docs              | https://era.micro.io/docs/dev/         |
      | Terms             | https://micro.io/terms                 |
      | Contact           | https://micro.io/contact      |
  ...
  Scenario Outline: Verify redirection for "<Icon>" social network icon  on Header
    ...
    Examples:
      ...
      | join    | https://join.micro.dev/           |
      | twitter | https://twitter.com/micro         |

  @id251
  Scenario: Verify redirection for Documentation link
    Given I click by text "Documentation"
    Then New page have "https://era.micro.io/docs/dev/" address
  ...
  Scenario Outline: Verify redirection for "<Sub-Section>" in Tools menu
    ...
    Examples:
      | Sub-Section | url                                           |
      | Portal      | https://calibration.staging-portal.micro.dev/     |
  ...
  Scenario Outline: Verify redirection for "<Sub-Section>" in Tools menu
    ...
    Examples:
      ...
      | Portal      | https://calibration.portal.micro.io/  |
  ...
  Scenario Outline: Verify redirection for "<Sub-Section>" in Tools menu
    ...
    Examples:
      | Sub-Section | url                                           |
      | Portal      | https://staging-portal.micro.dev/     |
