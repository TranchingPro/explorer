...
#    Given Page with part address "/block/" includes ID result
  ...
  Scenario Outline: Verify redirection to "<Network>" network 
    ...
    Examples: 
     ...
     | /address/0x000000000000000000000000000000000000800A      | zkAmoeba Testnet | /address/0x000000000000000000000000000000000000800A/?network=calibration      | 
     | /address/0x000000000000000000000000000000000000800A      | Calibration (Stage2)    | /address/0x000000000000000000000000000000000000800A/?network=calibration-beta | 
     | /address/0x000000000000000000000000000000000000800A      | zkAmoeba Mainnet | /address/0x000000000000000000000000000000000000800A/?network=mainnet     |
