...
import * as microSdk from "@zkamoeba/micro-web3";
...
export default (context = useContext()) => {
  const walletContext = {
    ...
    getL2Provider: () => null as unknown as microSdk.Provider,
  };
  ...
  const readFunction = async (
    ...
    try {
      ...
      response.value = undefined;
      errorMessage.value = null;
      let signer: microSdk.Provider | microSdk.Signer = new microSdk.Provider(context.currentNetwork.value.rpcUrl);
